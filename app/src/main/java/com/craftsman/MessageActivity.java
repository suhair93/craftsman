...
import com.craftsman.adapter.MessageAdapter;
import com.craftsman.customer.MainActivity;
import com.craftsman.model.Chat;
...
public class MessageActivity extends AppCompatActivity {
   ...
   // APIService apiService;
    ...
    private void seenMessage(final String userid){
        reference = FirebaseDatabase.getInstance("https://craftsman-c62e9-default-rtdb.firebaseio.com/").getReference("Chats");
...
//        DatabaseReference tokens = FirebaseDatabase.getInstance("https://cook-e2c2b-default-rtdb.firebaseio.com/").getReference("Tokens");
