...
public class WorkCraftsmanAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    String UId ;
    public WorkCraftsmanAdapter(Context context, List<Work> List1) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new Holder(LayoutInflater.from(parent.getContext()).inflate(R.layout.card_work, parent, false));
    }
        ...
        holder1.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseDatabase.getInstance().getReference().
                        child("Works").child(item.getId()).removeValue().addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
